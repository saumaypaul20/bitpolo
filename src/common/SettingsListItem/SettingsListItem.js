...
const SettingsListItem = (props) => {
    return (
        <TouchableOpacity onPress={()=>props.onPress ? props.onPress() : console.log("uo")}
         activeOpacity={0.8} 
         style={{flexDirection:'row', alignItems:'center', alignSelf:'stretch', borderTopWidth:1, borderColor: primaryColors.lightGray, paddingHorizontal:40, paddingVertical:18}}>
