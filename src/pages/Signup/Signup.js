...
const Signup = ({navigation}) => {
  ...
  const register = async () => {
    ...
    console.log(res);
    if (!res.status) {
      console.log(res.data.data.attributes.message);
      setloading(false);
      alert(
        res.data.data.attributes.message,
        // JSON.stringify(
        //   Object.values(res.data.data.attributes.message)[0],
        // ).replace(/['"]+/g, ''),
      );
      return;
    } else {
            ...
            <Card
              ...
              <View
                ...
                <LabelInput
                  ...
                  value={email}
                  onChangeText={t => {
                    dispatch(inputAction(TYPES.EMAIL_INPUT, t));
                  }}
                />
                <LabelInput
                  label="Phone No"
                ...
                <LabelInput
                  ...
                  onChangeText={t => {
                    setPassword(t);
                    dispatch(inputAction('PASSWORD', t));
                  }}
                />
                <LabelInput
                  secureTextEntry
