  ...
  const deleteBank = async i => {
    ...
    if (banks.length === 1) {
      ...
      if (res.status) {
        ...
        Alert.alert('Error', res.data.data.attributes.message);
      }
    }
  };
                ...
                return (
                  <React.Fragment key={i?._id}>
                    <SettingsListItem
                      ...
                      rightElement={
                        active ===
                        i?.type_of_account?.bank_account?.account_number ? (
                          <Chevron position="up" />
                        ) : (
                          <Chevron position="down" />
                        )
                      }
                      onPress={() =>
                        showDetails(
                      ...
                      <View
                        ...
                        <View>
                          ...
                          <View
                            ...
                            <BPText>
                              {i?.type_of_account?.bank_account?.account_type}
                            </BPText>
                          </View>
                          <View
                            style={{
                          ...
                          <View
                            ...
                            <BPText>IFSC:</BPText>
                            <BPText>
                              {i?.type_of_account?.bank_account?.ifsc}
                            </BPText>
                          </View>
                        </View>
                        <DelButton onPress={() => deleteBank(i)} />
                      </View>
                    )}
                  </React.Fragment>
                );
