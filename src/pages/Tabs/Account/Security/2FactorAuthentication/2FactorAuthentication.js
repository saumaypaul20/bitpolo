...
const TwoFactorAuthentication = () => {
  ...
  const isDisabled = () => {
    if (code.length !== 6 || password.length === 0 || load) {
      return true;
    }
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: Colors.primeBG}}>
      <Root>
        <Container style={{flex: 1, backgroundColor: Colors.primeBG}}>
          <Toolbar
            enableBackButton
            title={screenNames.TWO_FACTOR_AUTHENTICATION}
          />
                ...
                <>
                  <View>
                    <View
                      ...
                      <BPText
                        style={{lineHeight: 20, fontSize: 18, marginBottom: 8}}>
                      ...
                      <BPText
                        ...
                        Please enter the below alphanumeric code on your
                        authentication app.
                      </BPText>

                      <BPText
                        onPress={() => copyText(googlekey, 'Google Key')}
                        selectable
                        style={{
                          lineHeight: 20,
                          alignSelf: 'stretch',
                      ...
                      <BPText
                        ...
                        {' '}
                        Please make a note of the key shown above. In case you
                        lose your mobile device or delete the 'Google
                        Authenticator' app, this key allows you to recover your
                        BitPolo account.
                      </BPText>
                    </View>
                    <View style={{paddingTop: 20}}>
                      ...
                      <BPText style={{lineHeight: 20, opacity: 0.8}}>
