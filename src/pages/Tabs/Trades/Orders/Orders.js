        ...
        <View>
          <View
            ...
            <Text
              style={{
                backgroundColor:
                  item.type === 2 ? Colors.lightGreen : Colors.red,
                color: Colors.white,
                marginHorizontal: 5,
                paddingHorizontal: 5,
                fontSize: 10,
          ...
          <BPText style={{fontSize: 10, color: Colors.lightWhite}}>
            {convertTime(item.ctime * 1000)}{' '}
            {convertDate(item.ctime * 1000, '-')}
          </BPText>
        </View>
        <View>
          <Button
            ...
            <BPText style={{color: Colors.darkGray3, fontSize: 10}}>
              Cancel
            </BPText>
          </Button>
        </View>
...
const Orders = ({navigation}) => {
  ...
  const rightToolbarElement = () => {
    return (
      <Button
        transparent
        onPress={() => navigation.navigate(screenNames.ORDERS_HISTORY)}>
        ...
        <View
          ...
          {loading ? (
            ...
            <FlatList
                ...
                <View
                  ...
                  <View
                    ...
                    <Button
                      ...
                      <BPText style={{color: Colors.darkGray3, fontSize: 12}}>
                        Cancel All
                      </BPText>
                    </Button>
                  </View>
              ...
              renderItem={({item}) => (
                <ListItem item={item} onPress={() => cancelthisorder(item)} />
              )}
