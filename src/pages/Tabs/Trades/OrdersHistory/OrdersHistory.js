    ...
    <View
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          ...
          <Text
            style={{
              backgroundColor: item.side === 2 ? Colors.lightGreen : Colors.red,
              color: Colors.white,
              marginHorizontal: 5,
              paddingHorizontal: 5,
              fontSize: 10,
      ...
      <View
        ...
        <View style={{alignItems: 'flex-start'}}>
          <BPText style={{fontSize: 8}}>
            {Number(item.deal_fee)} {item.divider.a}
          </BPText>
          <BPText style={{fontSize: 8}}>
            {parseFloat(item.deal_money).toFixed(2)} {item.divider.b}
          </BPText>
        </View>
      </View>
    </View>
