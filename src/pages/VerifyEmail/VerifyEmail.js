...
const VerifyEmail = props => {
  ...
  const [progress, setprogress] = useState(false); //setting showProgress initial STATE value
  const pinCount = 6;
    ...
    <Container style={{flex: 1, backgroundColor: Colors.primeBG}}>
      ...
      <Content contentContainerStyle={{flexGrow: 1}}>
        <View
          ...
          <BPSubtitle
            text={`Please enter the ${pinCount} digit code sent to\n${email}`}
          />
        </View>
        <View
          style={{
